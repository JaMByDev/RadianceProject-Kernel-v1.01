...
kal_uint8 sp0a19_whitebalance = 0;
	         ...
	         if(SP0A19_MPEG4_encode_mode == KAL_TRUE)
	          {
				...
				//Video record daylight 24M 50hz 14-14FPS maxgain:0x80
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);	//0x00	modify by sp_yjp,20130314
					SP0A19_write_cmos_sensor(0x04,0xb0);	//0xd8
					SP0A19_write_cmos_sensor(0x06,0x00);
				...
				//Video record daylight 24M 60Hz 14-14FPS maxgain:0x80
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);	//0x00	modify by sp_yjp,20130314	
					SP0A19_write_cmos_sensor(0x04,0x68);	//0xb4
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x03);
					SP0A19_write_cmos_sensor(0x0a,0x31);
		...
		else 
			{
			   //	SENSORDB(" SP0A19_banding=%x\r\n",SP0A19_banding);
				...
				//capture preview daylight 24M 50hz 20-8FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x02);	//0x01	modify by sp_yjp,20130314
					SP0A19_write_cmos_sensor(0x04,0x64);	//0x32
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x01);
					SP0A19_write_cmos_sensor(0x0a,0x46);
					SP0A19_write_cmos_sensor(0xf0,0x66);
				...
				//capture preview daylight 24M 60hz 20-8FPS maxgain:0x70   
					SP0A19_write_cmos_sensor(0xfd,0x00);
					SP0A19_write_cmos_sensor(0x03,0x01);	//0x00	modify by sp_yjp,20130314
					SP0A19_write_cmos_sensor(0x04,0xfe);	//0xff
					SP0A19_write_cmos_sensor(0x06,0x00);
					SP0A19_write_cmos_sensor(0x09,0x01);
					SP0A19_write_cmos_sensor(0x0a,0x46);
					SP0A19_write_cmos_sensor(0xf0,0x55);
...
{  
	...
	SP0A19_write_cmos_sensor(0x65,0xDA);
	SP0A19_write_cmos_sensor(0x66,0xFE);
	SP0A19_write_cmos_sensor(0x67,0x6F);
	SP0A19_write_cmos_sensor(0x68,0x84);
	...
	SP0A19_write_cmos_sensor(0x61,0x8c);
	SP0A19_write_cmos_sensor(0x62,0xB4);
	SP0A19_write_cmos_sensor(0x63,0xc8);
	SP0A19_write_cmos_sensor(0x64,0xeb);
	
	SP0A19_write_cmos_sensor(0x6d,0xA6);
	SP0A19_write_cmos_sensor(0x6e,0xDA);
	SP0A19_write_cmos_sensor(0x6f,0xA9);
	SP0A19_write_cmos_sensor(0x70,0xCE);
	...
	SP0A19_write_cmos_sensor(0x58,0x0e);
	SP0A19_write_cmos_sensor(0x56,0x15);
	SP0A19_write_cmos_sensor(0x59,0x15);

	SP0A19_write_cmos_sensor(0x89,0x06);
	SP0A19_write_cmos_sensor(0x8a,0x0e);
	SP0A19_write_cmos_sensor(0x9c,0x15);
	SP0A19_write_cmos_sensor(0x9d,0x15);
	...
	SP0A19_write_cmos_sensor(0xe7,0x15);
	SP0A19_write_cmos_sensor(0xd5,0x15);
	SP0A19_write_cmos_sensor(0xd9,0x15);
	...
	SP0A19_write_cmos_sensor(0xec,0x20);

	SP0A19_write_cmos_sensor(0xe9,0x20);
	SP0A19_write_cmos_sensor(0xed,0x20);

	SP0A19_write_cmos_sensor(0xea,0x15);
	SP0A19_write_cmos_sensor(0xef,0x15);

	SP0A19_write_cmos_sensor(0xeb,0x10);
	SP0A19_write_cmos_sensor(0xf0,0x15);

	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0xa0,0x7d);
	SP0A19_write_cmos_sensor(0xa1,0x00);
	SP0A19_write_cmos_sensor(0xa2,0x00);
	SP0A19_write_cmos_sensor(0xa3,0xf4);
	SP0A19_write_cmos_sensor(0xa4,0x8c);
	SP0A19_write_cmos_sensor(0xa5,0x00);
	SP0A19_write_cmos_sensor(0xa6,0x00);
	SP0A19_write_cmos_sensor(0xa7,0xda);
	SP0A19_write_cmos_sensor(0xa8,0xa6);
	SP0A19_write_cmos_sensor(0xa9,0x00);
	SP0A19_write_cmos_sensor(0xaa,0x03);
	SP0A19_write_cmos_sensor(0xab,0x0c);
	
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x8b,0x00);
	SP0A19_write_cmos_sensor(0x8c,0x0a);
	SP0A19_write_cmos_sensor(0x8d,0x17);
	SP0A19_write_cmos_sensor(0x8e,0x2f);
	SP0A19_write_cmos_sensor(0x8f,0x50);
	SP0A19_write_cmos_sensor(0x90,0x6b);
	SP0A19_write_cmos_sensor(0x91,0x85);
	SP0A19_write_cmos_sensor(0x92,0x9b);
	SP0A19_write_cmos_sensor(0x93,0xac);
	SP0A19_write_cmos_sensor(0x94,0xbb);
	SP0A19_write_cmos_sensor(0x95,0xc7);
	SP0A19_write_cmos_sensor(0x96,0xd1);
	SP0A19_write_cmos_sensor(0x97,0xd8);
	SP0A19_write_cmos_sensor(0x98,0xe0);
	SP0A19_write_cmos_sensor(0x99,0xe7);
	SP0A19_write_cmos_sensor(0x9a,0xee);
	SP0A19_write_cmos_sensor(0x9b,0xf4);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xfa);
	...
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x94,0xb0);
	SP0A19_write_cmos_sensor(0x95,0x28);
	SP0A19_write_cmos_sensor(0x9c,0xb0);
	...
	SP0A19_write_cmos_sensor(0xef,0x78);
	SP0A19_write_cmos_sensor(0xf9,0x74);
	SP0A19_write_cmos_sensor(0xfa,0x6c);
	SP0A19_write_cmos_sensor(0xee,0x68);
	...
	SP0A19_write_cmos_sensor(0xd3,0x74);
	SP0A19_write_cmos_sensor(0xd4,0x74);
	SP0A19_write_cmos_sensor(0xd6,0x70);
	SP0A19_write_cmos_sensor(0xd7,0x68);

	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x74);
	SP0A19_write_cmos_sensor(0xde,0x9c);
...
UINT32 SP0A19GetSensorID(UINT32 *sensorID)
{
    ...
    do {
        ...
        SENSORDB("[SP0A19GetSensorID]Read Sensor ID Fail = 0x%x\n", sensor_id); 
...
UINT32 SP0A19Open(void)
{
    ...
    do {
        ...
        SENSORDB("[SP0A19Open]Read Sensor ID Fail = 0x%x\n", sensor_id); 
	...
	SP0A19_Sensor_Init();
#endif
	Sleep(500);	// 300 add by sp_yjp,20130314
...
{
	printk("[SP0A19_set_param_wb] para == %d\n", para);
	sp0a19_whitebalance = para;
	switch (para)
	{            
		case AWB_MODE_AUTO:
			{
			...
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xc5);	//0xc4                                              
			SP0A19_write_cmos_sensor(0x29,0x9b);   //0x9e
			SP0A19_write_cmos_sensor(0xfd,0x00);  // AUTO 3000K~7000K   	  
			SP0A19_write_cmos_sensor(0x32,0x15);  //0x0d modify by sp_yjp,20130301
			printk("@@@SP:WB1\r\n");
            }                
		    break;
...
//	kal_uint32  ret = KAL_TRUE;
	printk("[SP0A19_set_param_effect] para == %d\n", para);
	switch (para)
	{
		case MEFFECT_OFF:
			{
...
{
	printk("[SP0A19_set_param_banding] para == %d\n", para);
	switch (para)
	{
...
{
	#if 1	// 1 ,test by sp_yjp,20130228
	printk("[SP0A19_set_param_exposure] para == %d\n", para);
	switch (para)
	{
...
void SP0A19GetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->AWBMode = sp0a19_whitebalance;
