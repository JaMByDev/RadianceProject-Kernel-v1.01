...
typedef struct
{
	...
	#define OV8826_FULL_PERIOD_PIXEL_NUMS					0x0E30  //3632
	#if defined(ZSD15FPS)
	#define OV8826_FULL_PERIOD_LINE_NUMS					0x9F0	//2544
	#else
	...
	#define OV8826_IMAGE_SENSOR_PV_INSERTED_PIXELS			2	// Sync, Nosync=2
